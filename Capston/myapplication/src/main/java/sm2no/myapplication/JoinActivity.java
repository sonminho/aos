...
public class JoinActivity extends AppCompatActivity {
    ...
    public class IdCheckAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                URL url = new URL("http://192.168.0.100:8080/Capston/AndroidServlet?command=android_idCheck&userid="+params[0]);
    ...
    public class JoinAsyncTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://192.168.0.100:8080/Capston/AndroidServlet?command=android_join");
                HttpURLConnection conn = (HttpURLConnection) url.openConnection();
