...
<div id="wrap">
	...
	<div id="container">
		...
		<div id="content">
			<ul>
				<% ArrayList<OrderVO> list = (ArrayList<OrderVO>)request.getAttribute("order_list"); %>
				<li><%= user_id%>의  주문 리스트</li>
			</ul>
			<div id="product_list">
				<table>
					<tr style="height:100px; background:#f1f1f1;">
						<td style="width:200px;">주문번호</td>
						<td style="width:200px;">상품&nbsp;이미지</td>
						<td style="width:200px;">상품&nbsp;이름</td>
						<td style="width:100px;">상품&nbsp;가격</td>
						<td style="width:520px;">요청&nbsp;배송지</td>
					</tr>
				<%
					for(OrderVO oVo : list) {
				%>
					<tr>
						<td style="width:200px;"><%= oVo.getOrder_number() %></td>
						<td style="width:200px;">
						<%
								String imagePath = request.getContextPath() +"/upload_image/"
								+ oDao.getProductByOrderNumber(oVo.getOrder_product_number()).getProductImage();
								System.out.println(imagePath + "이미지 경로");
						%><img src="<%=imagePath %>" border=0 width="150px" height="150px">
						</td>
						<td style="width:200px;"><%= oVo.getOrder_product_name() %></td>
						<td style="width:100px;"><%= oVo.getOrder_price() %></td>
						<td style="width:520px;"><%= oVo.getOrder_address() %></td>
