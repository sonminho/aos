 ...
 * Generated at: 2017-12-07 18:56:47 UTC
...
public final class user_005foder_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ProductVO pVo = (ProductVO)request.getAttribute("product"); 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<img border=0 width=550px height=550px src=\"");
      out.print(imagePath );
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td id=\"detail\" style=\"width:540px; height:600px;\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"detail_table\">\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:600px; height:100px;\"><th style=\"width:120px; text-align:center\">상&nbsp;품&nbsp;변&nbsp;호&nbsp;&nbsp;:\r\n");
      out.write("\t\t\t\t\t\t\t</th><td style=\"width:480px;\">");
      out.print( pVo.getProductNumber() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:540px; height:100px;\"><th style=\"width:100px; text-align:center\">&nbsp;&nbsp;성&nbsp;&nbsp;별&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:\r\n");
      out.write("\t\t\t\t\t\t\t</th><td style=\"width:480px;\">");
      out.print( pVo.getProductSexCategory() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:540px; height:100px;\"><th style=\"width:120px; text-align:center\">상&nbsp;품&nbsp;농&nbsp;도&nbsp;&nbsp;:\r\n");
      out.write("\t\t\t\t\t\t\t</th><td style=\"width:480px;\">");
      out.print( pVo.getProductLevelCategory() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:540px; height:100px;\"><th style=\"width:120px; text-align:center\">상&nbsp;품&nbsp;가&nbsp;격&nbsp;:\r\n");
      out.write("\t\t\t\t\t\t\t</th><td style=\"width:480px;\">");
      out.print( pVo.getProductPrice() );
      out.write("원</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:540px; height:150px;\"><th style=\"width:120px; text-align:center\">상&nbsp;품&nbsp;내&nbsp;용&nbsp;:\r\n");
      out.write("\t\t\t\t\t\t\t</th><td style=\"width:480px;\">");
      out.print( pVo.getProductContent() );
      out.write("</td></tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr style=\"width:540px; height:100px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"button\" style=\"width:160px; height:50px; margin-left:30px\" value=\"주문하기\" \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tonclick=\"location.href='ControllerServlet?command=user_order&product_number=");
      out.print(pVo.getProductNumber());
      out.write("'\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"button\" style=\"width:160px; height:50px; margin-left:30px\" value=\"장바구니\"></input>\r\n");
      out.write("\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
