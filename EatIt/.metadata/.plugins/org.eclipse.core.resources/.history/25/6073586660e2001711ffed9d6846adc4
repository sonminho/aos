...
<div id="container">
	...
	<div id="content">
		...
		<div id="content_list">
			...
			<table>
				<tr>
					<th style="width:400px;">아&nbsp;이&nbsp;디</th><td><input name="user_id" type="text" style="width:200px; hiehgt:20px"></td>
				</tr>
				<tr>
					<th style="width:400px;">비&nbsp;밀&nbsp;번&nbsp;호</th><td><input name="user_password" type="password" style="width:200px; hiehgt:20px"></td>
				</tr>
				<tr>
					<td style="padding-left:150px;"><input type="submit" style="width:200px;" value="로그인"></td>
					<td><input type="button" style="width:200px;" value="회원가입" onclick="location.href='join_main.jsp'"></td>  
				</tr>
			</table>
			</form>
		</div>
