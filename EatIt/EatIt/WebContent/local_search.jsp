...
<div id="container">
	...
	<div id="content">
		<ul>
			...
			<li><a href="#"><%= request.getAttribute("place_location") %>의 맛집 리스트</a></li>
		</ul>
		<div id="content_list">
			<table>
			<%
			...
			%>
				<tr>
					...
					<td style="width:150px;"><%= pVo.getPlace_name() %></td>
					<td style="width:560px;"><a href="ControllerServlet?command=place_detail&place_number=<%=pVo.getPlace_number() %>"><%= pVo.getPlace_content() %></a></td>
					<td style="width:200px;"><%= pVo.getPlace_type() %></td>
					<td style="width:200px;"><%= pVo.getPlace_hour() %></td>
			<%
				}
			%>
				</tr>
